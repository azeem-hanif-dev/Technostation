...
<div id="wrapper">
  @section('content')
    <div id="app" v-cloak>
      ...
      <input type="hidden" ref="id" value="{{$projectCostEstimate->id}}">
        ...
        <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading">
              @lang('common.Edit project calculation')
            </div>
            <!-- /.panel-heading -->
              ...
              <div class="">
                <form @submit.prevent="updateProject">
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" v-model:value="project_data.project_name">
                  ...
                  <div class="form-group row">
                    <div class="col-md-10 col-md-offset-2">
                      <div class="col-md-4">
                        <input type="radio" value="new" id="new1" v-model="project_data.client_type" @input="clientTypeChanged">
                        <label for="new1"> @lang('Company_Admin/dashboard.new_client')</label>
                      </div>

                      <div class="col-md-4">
                        <input type="radio" value="old" id="old1" v-model="project_data.client_type">
                        <label for="old1"> @lang('Company_Admin/dashboard.existing_client')</label>
                      </div>
                    </div>
                  </div>

                  <template v-if="project_data.client_type == 'new'">
                    <div class="form-group row">
                      <label class="col-md-2" for="">@lang('Company_Admin/dashboard.client_name'):*</label>
                      <div class="col-md-8">
                        <input class="form-control" type="text" v-model:value="project_data.client_name">
                  ...
                  <template v-else>
                    <div class="form-group row">
                      <label class="col-md-2" for="">@lang('Company_Admin/dashboard.client_name'):*</label>
                      <div class="col-md-8">
                        <v-select :clearable = "false" :options="customers" @input="customerChanged" label="name" v-model="project_data.client" placeholder="Select Customer">
                        </v-select>
                      </div>
                    </div>
                  </template>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="email" v-model:value="project_data.email">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" v-model:value="project_data.phone">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" v-model:value="project_data.address">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" v-model:value="project_data.contact_person1">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" v-model:value="project_data.contact_person2">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" id="startDate" v-model:value="project_data.start_date" placeholder="dd/mm/yy">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" id="endDate" v-model:value="project_data.end_date" placeholder="dd/mm/yy">
                  ...
                  <div class="form-group row">
                    <div class="panel panel-info">
                      <div class="panel-heading">
                        ...
                        <button type="button" class="btn btn-warning btn-sm pull-right" data-toggle="modal" data-target="#normModal" @click.prevent= "addNewAreaEstimate = true;"><i class="fa fa-plus"></i></button>
                      </div>
                      <div class="panel-body">
                        <template v-if="areaEstimateTable.length > 0">
                          <div class="form-group row">
                            <div class="col-md-16 col-md-offset-1 table-responsive">
                              <table class="table table-bordered table-hovered table-striped">
                                ...
                                <tbody>
                                <tr v-for="(data, index) in areaEstimateTable">
                                  <td>@{{data.floor_type}}</td>
                                  <td>@{{data.room_type}}</td>
                                  <td>@{{data.frequency}}</td>
                                  <td>@{{data.factor}}</td>
                                  <td>@{{data.sq_meter_area_per_hour}}</td>
                                  <td>
                                    <button
                                            type="button"
                                            data-toggle="modal" data-target="#normModal"
                                            class="btn btn-info btn-md" title="@lang('Company_Admin/dashboard.Edit')" @click.prevent="editNormRow(index)"><i class="fa fa-pencil-square-o"></i>
                                    </button>
                  ...
                  <div class="form-group row" v-show="areaEstimateTable.length > 0">
                    <div class="panel panel-info">
                      <div class="panel-heading">
                              ...
                              <table class="table table-bordered table-hovered table-striped">
                                ...
                                <tr v-for="(data, index) in space_State_Table">
                                  ...
                                  <td>
                                    <button
                                            type="button"
                                            data-toggle="modal" data-target="#spaceStateModal"
                                            class="btn btn-info btn-md" title="@lang('Company_Admin/dashboard.Edit')" @click.prevent="editSpaceStateRow(data,index)"><i class="fa fa-pencil-square-o"></i>
                                    </button>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  <thead>
                    ...
                    <th>@lang('Company_Admin/dashboard.Hourly Rate Structure')</th>
                  </thead>
                  <tbody>
                  ...
                  <tfoot>
                    <tr>
                      <td></td>
                      <th><span style="background-color: #f44336;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Hours a Year')</span></th>
                      <td>@{{prd_hr_mon_fri_total_hour}} </td>
                      <th><span style="background-color: #f44336;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Production') @lang('Company_Admin/dashboard.Price a Year')</span></th>
                      <td>@{{prd_hr_mon_fri_Total_price}}</td>
                      <th><span style="background-color: #f44336;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Production') @lang('Company_Admin/dashboard.Cost a Year')</span></th>
                      <td>@{{prd_hr_mon_fri_Total_cost}}</td>
                      <th><span style="background-color: #f44336;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Production') @lang('Company_Admin/dashboard.Cost a Year') / @lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Hours a Year')</span></th>
                      <td>&#163; @{{prd_hr_mon_fri_Total_hourly_structure}}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td></td>
                      <th><span style="background-color: #33cc33;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Direct Supervision') @lang('Company_Admin/dashboard.Hours a Year')</span></th>
                      <td>@{{drt_sup_hr_mon_fri_total_hour}} </td>
                      <th><span style="background-color: #33cc33;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Direct Supervision') @lang('Company_Admin/dashboard.Price a Year')</span></th>
                      <td>@{{drt_sup_hr_mon_fri_Total_price}}</td>
                      <th><span style="background-color: #33cc33;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Direct Supervision') @lang('Company_Admin/dashboard.Cost a Year')</span></th>
                      <td>@{{drt_sup_hr_mon_fri_Total_cost}}</td>
                      <th><span style="background-color: #33cc33;">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Direct Supervision') @lang('Company_Admin/dashboard.Cost a Year') / @lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Hours a Year')</span></th>
                      <td>&#163; @{{drt_sup_hr_mon_fri_Total_hourly_structure}}</td>
                    </tr>
                  </tbody>
                  <tfoot>
                    <tr>
                      ...
                      <th></th>
                      <td></td>
                      <th><span style="background-color: #ffcc00;">
...
@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Cost a Year') = @lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Production') @lang('Company_Admin/dashboard.Cost a Year') + @lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Direct Supervision') @lang('Company_Admin/dashboard.Cost a Year')
            ...
            <th><span style="background-color: #ffcc00;">
@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.Hourly rate Structure')
            </span></th>
            <td>
              @{{prd_hr_mon_fri_Total_hourly_structure}} +
              @{{drt_sup_hr_mon_fri_Total_hourly_structure}} =
&#163; @{{space_State_final.total_rate_structure}}</td>
                    </tr>
                    <tr></tr>
                    <tr>
                      <td></td>
                      <th><span style="background-color: #80b3ff;">
  ...
  <div class="col-lg-6">
    <div class="well">
        <h4>@lang('Company_Admin/dashboard.Calculation') @lang('Company_Admin/dashboard.Information') :</h4>
                  <p>@lang('Company_Admin/dashboard.Average') @lang('Company_Admin/dashboard.Hour') @lang('Company_Admin/dashboard.Rate')(@lang('Company_Admin/dashboard.Included') @lang('Company_Admin/dashboard.Management')) = @{{space_State_final.rate}}</p>
                  <p>@lang('Company_Admin/dashboard.Average') @lang('Company_Admin/dashboard.Rate') @lang('Company_Admin/dashboard.Production') = @{{prd_hr_mon_fri_rate}}</p>
                  <p>@lang('Company_Admin/dashboard.Average') @lang('Company_Admin/dashboard.Rate') (@lang('Company_Admin/dashboard.Exempted') @lang('Company_Admin/dashboard.Management'))= @{{drt_sup_hr_mon_fri_rate}}</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="well">
      ...
      <div id="normModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
          ...
          <div class="modal-content">
              ...
              <form role="form">
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <v-select :options="floor_types" label="name" v-model="normModal.floor_type" placeholder="@lang('Company_Admin/dashboard.Select') @lang('Company_Admin/dashboard.Floor') @lang('Company_Admin/dashboard.Type')" @input="floorTypeChanged">
                    </v-select>
                  </div>

                  <div class="col-md-6">
                    <label for="floorType">@lang('Company_Admin/dashboard.room_type')</label>
                    <v-select :options="room_types" label="name" v-model="normModal.room_type" placeholder="@lang('Company_Admin/dashboard.Select') @lang('Company_Admin/dashboard.Room') @lang('Company_Admin/dashboard.Type')" @input="roomTypeChanged">
                    </v-select>
                  </div>
                </div>
                ...
                <div class="form-group row" v-show="comments.length > 1">
                  <div class="col-md-6">
                    ...
                    <v-select :options="comments" label="comments" v-model="normModal.comment" placeholder="@lang('Company_Admin/dashboard.Select') @lang('Company_Admin/dashboard.Comment')">
                    </v-select>
                  </div>
                </div>
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-footer  table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <tr v-for="(task,id) in normModal.tasks_table">
                        <td>@{{task.task_name}}</td>
                        <td>@{{task.task_frequency}}</td>
                        <td> <button
                                  type="button"
                                  name="button"
                                  class="btn btn-danger btn-md" @click.prevent="deleteTask(task,id)"><i class="fa fa-trash"></i>
                          </button>
                        </td>
                      </tr>
                      </tbody>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-8">
                        <input class="form-control" type="text" name="" v-model:value="normModal.maxFrequency" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-footer table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                      <tr v-for="(element,id) in normModal.elements_table">
                        <td>@{{element.element_name}}</td>
                        <td>@{{element.element_frequency}}</td>
                        <td> <button
                                  type="button"
                                  name="button"
                                  class="btn btn-danger btn-md" @click.prevent="deleteElement(element,id)"><i class="fa fa-trash"></i>
                          </button>
                        </td>
                      </tr>
                      </tbody>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <input class="form-control" type="number" min="0" max="2" name="factor" v-model:value="normModal.factor">
                  </div>
                </div>
            ...
            <div class="modal-footer inline">
              ...
              <template v-if="addNewAreaEstimate">
                <button type="button" :disabled="addButton"
                        class="btn btn-success"
                        data-dismiss="modal"
                        @click.prevent="addNormRow" >
            ...
            <div class="modal-body">
              ...
              <form role="form">
                ...
                <div class="form-group row">
                  ...
                  <template v-if="space_State_edit">
                    <div class="col-md-6">
                      <label for="floorType">@lang('Company_Admin/dashboard.Total') @lang('Company_Admin/dashboard.sq_meter_area_perHour')</label>
                      <input class="form-control" type="text" name="" v-model:value="total_sq_meter_area_comp_temp" readonly>
                    </div>
                  </template>
                  <template v-else>
                    <div class="col-md-6">
                  ...
                  <div class="panel-footer table-responsive">
                    <table class="table table-striped">
                      ...
                      <tr v-for="(entry,id) in prd_hr_mon_fri_Table">
                        ...
                        <td>@{{entry.percentage}}%</td>
                        <td>
                          <template v-if="entry.group_name != 'Employer General Cleaning Group 1'">
                            <button
                                    type="button"
                                    name="button"
                                    class="btn btn-danger btn-md" @click.prevent="delprdhrGroup(entry.group_id,id,entry.percentage)"><i class="fa fa-trash"></i>
                            </button>
                          </template>
                        </td>
                      </tr>

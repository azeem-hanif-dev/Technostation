  ...
  <div id="wrapper">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-right">
        <a href="{{route('material.create')}}", class="btn btn-primary btn-sm" style="margin-top: 30px; margin-left: 15px;"><i class="fa fa-plus" aria-hidden="true"></i>@lang('Company_Admin/dashboard.Add') @lang('Company_Admin/dashboard.New') @lang('Company_Admin/dashboard.Material')</a>
      </div>
    </div>
                          ...
                          @foreach ($materials as $key => $material)
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href="{{route('material.delete',$material->id)}}" data-toggle="tooltip" data-placement="top" title="@lang('Company_Admin/dashboard.Delete')"><i class="fa fa-times" style="color:red;"></i></a>
                                </td>
                            </tr>
                          @endforeach

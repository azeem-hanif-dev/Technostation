...
@section('title', 'Dashboard')
                  ...
                  <div class="">
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-8">
                            <input type="url" class="form-control" v-model:value="url" name="url" placeholder="https://example.com">
                          </div>
                        </div>
                        ...
                        <div class="inline pull-right">
                          ...
                          <a href="{{ route('employ_agency.index') }}" type="button" class="btn btn-danger">@lang('Company_Admin/dashboard.Cancel')</a>
                        </div>
                  </div>
                </div>
            </div>
  ...
  <script src="{{asset('js/Empl_agency/add.js')}}"></script>
  @endsection

...
<body>
    ...
    <main>
        ...
        <p><b>Datum:{{ \Carbon\Carbon::parse($offer->date)->format('d F Y') }}</p></b>
        <p><b>Betreft: {{ $offer->service_type }}</p></b>
        <p><b>Project: {{ $offer->project->name ?? '-' }}</p></b>
        <p><b>Project nummer: {{ $offer->project->project_number ?? '-' }}</p></b>
        <p><b>Ons kenmerk: {{ $offer->our_reference }}</p></b>
        ...
        <div style="border: 2px solid #000; padding: 15px; font-family: Arial, sans-serif; font-size: 14px;">
            <p>
                @if ($offer->service_type === 'traffic_controller')
                    <b>
            ...
            <p style="text-align: right;">
                <b>Totaal prijs:</b> &euro;{{ number_format($offer->traffic_controllers_price, 2, ',', '.') }}
            </p>
            <p>
            ...
            <div>
                ...
                <hr>
                <p style="text-align: right;">
                    <b>Totaal prijs:</b> &euro;{{ number_format($offer->construction_price, 2, ',', '.') }}
                </p>

...
<body>
    ...
    <div style="border: 1px solid #000; padding: 5px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td width="70%">{{ $project->name ?? 'N/A' }}</td>
            </tr>
            <tr>
                <td width="30%"><span style="margin-left: 5px;">KLANT PROJ. NR:</span></td>
                <td width="70%">{{ $project->customer->name ?? 'N/A' }}</td>
            </tr>
            <tr>
    ...
    <table class="weekcard">
        ...
        <tr>
            ...
            <td class="center">{{ $weekCard->hours_1 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_2 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_3 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_4 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_5 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_6 ?: '-' }}</td>
            <td class="center">{{ $weekCard->hours_7 ?: '-' }}</td>
            <td class="center">{{ $weekCard->total_hours }}</td>
            <td class="left">{{ $weekCard->comments }}</td>
        </tr>
        <tr>
            <td colspan="9" class="right strong">Totale uren:</td>
            <td class="right">{{ $weekCard->total_hours }}</td>
            <td></td>
        </tr>

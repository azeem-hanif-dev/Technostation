<header class="main-header">
  ...
  <a href="{{route('/')}}" class="logo">
    ...
    <span class="logo-lg"><b>Advance</b> Cleaning Service</span>
  </a>
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            {{-- <li class="user-body">
              <div class="row">
                <div class="col-xs-4 text-center">
                  <a href="#">@lang('Super_Admin/dashboard.Followers')</a>
                </div>
                <div class="col-xs-4 text-center">
                  <a href="#">@lang('Super_Admin/dashboard.Sales')</a>
                </div>
                <div class="col-xs-4 text-center">
                  <a href="#">@lang('Super_Admin/dashboard.Friends')</a>
                </div>
              </div>
              <!-- /.row -->
            </li> --}}
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="{{route('sup_admin.profile')}}" class="btn btn-default btn-flat">@lang('Super_Admin/dashboard.Profiles')</a>
              </div>

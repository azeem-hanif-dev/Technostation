  ...
  methods:{
    ...
    saveDetails(){
      ...
      if (this.phoneDetails && !this.phoneDetails.isValid){
        ...
        axios.post(APP_URL + `saveCompany`,{
          'email' : this.email,
          'password' : this.pass,
          'name' : this.name,
          'city' : this.city,
          ...
          'allow_leaves': this.allow_leaves,
        })
        .then(response => {
          this.$swal("Good job!", (this.selectedLanguage == 'en')?"Company added successfuly":"Bedrijf heeft succesvol toegevoegd", "success");
          this.email          = '';
          this.pass           = '';
          this.name           = '';
          this.city           = '';

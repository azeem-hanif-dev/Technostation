...
(function($) {
    ...
    // Create the Dark Mode toggle checkbox
    // 1️⃣ Create the checkbox
    var $dark_mode_checkbox = $("<input />", {
        ...
        if ($(this).is(":checked")) {
            ...
            localStorage.setItem("adminlte_darkmode", "true");
        } else {
            $("body").removeClass("dark-mode");
            localStorage.setItem("adminlte_darkmode", "false");
        }
    });

    if (localStorage.getItem("adminlte_darkmode") === "true") {
        $("body").addClass("dark-mode");
